local names = {"tripi", "gelox ultimate", "gelox returns", "oliveira ed", "gelox", "paladino macabro", "cafyun", "downlink", "uplink"}if not table.find(names, player:getName():lower()) then return end
